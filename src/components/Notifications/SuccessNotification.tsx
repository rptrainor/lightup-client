      ...
      <div class="p-4">
        <div class="flex items-start">
          ...
          <div class="ml-3 w-0 flex-1 pt-0.5">
            <p class="text-sm text-brand_black">{props.Header}</p>
            <p class="mt-1 text-sm text-gray-600">{props.SubHeader}</p>
          </div>
          <div class="ml-4 flex flex-shrink-0">
            <button
              type="button"
              class="inline-flex text-gray-600 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-utility_success_shade focus:ring-offset-2 border-solid"

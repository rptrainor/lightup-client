...
const PinterestShareButton = (props: Props) => {
  const shareOnPinterest = () => {
    const pinterestUrl = `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(props.url)}&media=${encodeURIComponent(props.image)}&description=${encodeURIComponent(props.text)}`;
